...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=OPREKIN-PC\\SQLEXPRESS;Database=AirplaneSystem;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Airplane>(entity =>
        {
            entity.HasKey(e => e.AirplaneId).HasName("PK__Airplane__5ED76B85D3341B32");
        ...
        {
            entity.HasKey(e => e.FlightId).HasName("PK__Flight__8A9E148E19664095");
        ...
        {
            entity.HasKey(e => e.PassengerId).HasName("PK__Passenge__88915F9093FBA7CA");
        ...
        {
            entity.HasKey(e => e.PilotId).HasName("PK__Pilot__B305516D5D927CD5");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F046BAAA033");
